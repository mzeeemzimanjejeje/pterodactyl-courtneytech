...
<head>
    ...
    <style>
        :root {
            ...
            /* Aliases so the rest of this page's existing CSS (which
               references --gray-*/--cyan-*/--black) stays in sync with
               the admin-configurable panel theme, without having to
               rewrite every rule below. */
            --gray-900: rgb(var(--color-neutral-900));
            --gray-800: rgb(var(--color-neutral-800));
            --gray-700: rgb(var(--color-neutral-700));
            --gray-600: rgb(var(--color-neutral-600));
            --gray-500: rgb(var(--color-neutral-500));
            --gray-400: rgb(var(--color-neutral-400));
            --gray-300: rgb(var(--color-neutral-300));
            --gray-200: rgb(var(--color-neutral-200));
            --gray-100: rgb(var(--color-neutral-100));
            --black: rgb(var(--color-neutral-900));
            --cyan-600: rgb(var(--color-primary-600));
            --cyan-500: rgb(var(--color-primary-500));
            --cyan-400: rgb(var(--color-primary-400));
        }
...
<body>
    ...
    <section class="pricing" id="resources" style="background: var(--gray-800);">
        ...
        <h2 class="section-title">Pick &amp; Choose Pricing</h2>
